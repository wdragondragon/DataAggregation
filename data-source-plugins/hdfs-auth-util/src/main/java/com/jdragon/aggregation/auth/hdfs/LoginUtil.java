...
public class LoginUtil {
    ...
    private static final Map<String, JaasConfiguration> configCache = new HashMap<>();
    ...
    public synchronized static UserGroupInformation login(String userPrincipal, String userKeytabPath, String krb5ConfPath, Configuration conf)
        ...
        LOG.info("krbConfAbsolutePath:" + krb5ConfFile.getAbsolutePath());
    ...
    public static void setJaasConf(String loginContextName, String principal, String keytabFile)
        ...
        if (!configCache.containsKey(loginContextName)) {
            configCache.put(loginContextName, new JaasConfiguration(loginContextName, principal,
                    userKeytabFile.getAbsolutePath()));
        }
        jaasConfiguration = configCache.get(loginContextName);
    ...
    private static class JaasConfiguration extends javax.security.auth.login.Configuration {
        ...
        private final Map<String, String> KEYTAB_KERBEROS_OPTIONS = new HashMap<>();
        ...
        private final AppConfigurationEntry KEYTAB_KERBEROS_LOGIN = new AppConfigurationEntry(
        ...
        private JaasConfiguration(String loginContextName, String principal, String keytabFile, boolean useTicketCache) throws IOException {
            try {
                ...
                while (this.baseConfig != null && this.baseConfig instanceof JaasConfiguration) {
                    this.baseConfig = ((JaasConfiguration) this.baseConfig).baseConfig;
                }
