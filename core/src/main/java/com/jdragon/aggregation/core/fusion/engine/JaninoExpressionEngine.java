...
public class JaninoExpressionEngine implements ExpressionEngine {
    ...
    public String[] getReferencedFields(String expression) {
        ...
        // 实际应该使用更复杂的解析
        java.util.regex.Pattern pattern = java.util.regex.Pattern.compile("\\b([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)\\b");
    ...
    private String replaceFieldReferences(String expression) {
        ...
        while (matcher.find()) {
            ...
            String replacement = "ctx.getValue(\"" + fieldRef + "\")";
