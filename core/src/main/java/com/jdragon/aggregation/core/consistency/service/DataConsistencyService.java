...
public class DataConsistencyService {
    ...
    public ComparisonResult executeRule(ConsistencyRule rule) {
        ...
        try {
            ...
            StreamingConsistencyExecutor executor = new StreamingConsistencyExecutor(pluginManager, resultRecorder);
            ComparisonResult result = executor.execute(rule, fetcher);
