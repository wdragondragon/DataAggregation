...
public class AdaptiveSortMergeFusionExecutor {
    ...
    public SortMergeStats execute(RecordSender recordSender) throws Exception {
        ...
        if (fusionConfig.getCacheConfig() != null) {
            options.setPartitionCount(fusionConfig.getCacheConfig().getPartitionCount());
            options.setRebalancePartitionMultiplier(fusionConfig.getCacheConfig().getRebalancePartitionMultiplier());
        }
        if (fusionConfig.getPerformanceConfig() != null) {
            options.setParallelSourceCount(fusionConfig.getPerformanceConfig().getParallelSourceCount());
            options.setMemoryLimitMB(fusionConfig.getPerformanceConfig().getMemoryLimitMB());
        }
